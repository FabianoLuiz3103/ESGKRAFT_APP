...
<head>
    ...
    <title>Atualização cliente success!</title>
...
<div class="custom-center">
    <div class="container-fluid text-center mt-5 rounded border border-4 border-dark bg-secondary custom-border custom-center h-75">
        <div class="row d-flex justify-content-center">
            ...
            <div class="mt-4">
                <h3>ATUALIZAÇÃO DE CLIENTE REALIZADA COM SUCESSO!</h3>
            </div>
            <div class="btn-group mt-5 d-flex flex-column align-items-center">
                <div class="col-md-6 col-lg-6 mb-3">
                    <a href="/SprintFinal/updateCliente.jsp"><button type="submit" name="atualizarMaisCliente" value="atualizarMaisCliente" class="btn btn-outline-white btn-primary btn-hover w-100">FAZER MAIS UPDATE DE CLIENTE</button></a>
                </div>
                <div class="col-md-6 col-lg-6 mb-3">
